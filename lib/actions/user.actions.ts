...
export const exchangePublicToken = async ({
    ...
    try {
       //Exchange puclic token for access token and item ID 
       ...
       const accountResponse = await plaidClient.accountsGet({
        ...
        //Create a bank account using  the User ID , item ID, account ID , acess TOKEN,
        //funding source URL and shareble ID
        ...
        //Revalidate the pathh to reflect the changes
        revalidatePath("/");
